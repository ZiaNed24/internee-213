...
$query="INSERT INTO `makeup_category`(`category_type`, `discount`) VALUES ('$var_p_name','$var_p_discount')";
...
$var_id=$_GET["id"];
$query="DELETE FROM `makeup_category` WHERE id='$var_id'";
$result = query_exec($query);
                        ...
                        <div class="col-md-4">
                            <form method="post" action="categories_add.php">
                                ...
                                <input type="hidden" value="<?php echo $rows['id'];?>" name="p_id" />
                                    ...
                                    <input type="text"  name="p_name" placeholder="Type here" class="form-control"
                                        id="product_name" autocomplete="off" />
                                </div>

                                <div class="mb-4">
                                    <label class="form-label">Discount</label>
                                    <input type="text" name="p_discount" placeholder="Type here" class="form-control"
                                        id="product_name" autocomplete="off" />
                                </div>
                                <div class="d-grid">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $query = "SELECT * FROM `makeup_category`";
                                        $result = query_exec($query);
                                    ...
                                    <tr>
                                        ...
                                        <td><b><?php echo $rows["category_type"] ?></b></td>
                                        ...
                                        <td class="text-end">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="mak_update.php?u_id=<?php echo $rows['id'] ?>">Edit info</a>
                                                    <a class="dropdown-item text-danger" href="categories_add.php?id=<?php echo $rows['id'] ?>">Delete</a>
                                                </div>
                                            </div>
                                            <!-- dropdown //end -->
                                        </td>

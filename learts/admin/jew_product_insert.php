...
if (isset($_POST["submit"]) && !empty($_FILES["file"]["name"])) {
    ...
    if (in_array($fileType, $allowTypes)) {
        ...
        if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)) {
            $result = query_exec("INSERT INTO `jewelery_products`(`name`, `jew_sub_id`,`jew_price`,`jew_status`, `jew_images`)  VALUES ('$var_name','$var_category','$var_price','$var_status', '$fileName')");
...
<body>
    ...
    <main class="main-wrap">
        ...
        <section class="content-main" style="max-width: 720px">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form method="post" action="jew_product_insert.php" enctype="multipart/form-data">
                        <div class="mb-4">

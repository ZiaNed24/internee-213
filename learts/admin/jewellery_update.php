...
if (isset($_GET["u_id"])) {
    $id =$_GET["u_id"];
    $result = query_exec("select * from jewelery_sub WHERE id='$id'");
 ...
 if (isset($_POST["submit"])) {
    ...
    $var_brand=$_POST["p_brand"];
    $var_disc=$_POST["discount"];
    $result = query_exec("UPDATE `jewelery_sub` SET `jewelery_name`='$var_name',`jewelery_brand`='$var_brand',`jew_discount`='$var_disc' WHERE id='$id'");
    $row = mysqli_fetch_assoc($result);
} 
...
<body>
    ...
    <main class="main-wrap">
        ...
        <section class="content-main" style="max-width:920px">
            ...
            <div class="card mb-4">
                <form method="post" action="jewellery_update.php">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="hidden" name="p_id" value="<?php echo $row["id"] ?>" placeholder="Type here" class="form-control">
                                    ...
                                    <input type="text" name="p_name" value="<?php echo $row["jewelery_name"] ?>" placeholder="Type here" class="form-control">
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="mb-4" style="max-width:250px;">
                                    ...
                                    <input type="text" name="p_brand" value="<?php echo $row["jewelery_brand"] ?>" placeholder="00.0" class="form-control">
                                </div>
                            </div> <!-- col.// -->
                        </div> 
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="mb-4" style="max-width:250px;">
                                    ...
                                    <input type="text" name="discount" value="<?php echo $row["jew_discount"] ?>" placeholder="00.0" class="form-control">
                                </div>
                            </div> <!-- col.// -->
                        </div> <!-- row.// -->
